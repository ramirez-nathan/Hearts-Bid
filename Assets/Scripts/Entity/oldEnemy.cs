...
public class Enemy : Entity
{
    ...
    protected float avoidRange = 2.0f;
    protected float spacingRange = 2.0f;
    protected bool nearObstacle;
    protected float avoidStrength = 15.0f; //how hard to avoid obstacles
    ...
    private void FixedUpdate()
    {
        ...
        {
            entityRb.linearVelocity = moveDir * moveSpeed;
        }

        else
        {
            entityRb.linearVelocity = Vector2.zero;
        }
    }
